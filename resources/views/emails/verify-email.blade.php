...
<head>
    ...
    <title>Finaliser mon inscription</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <h1 class="email-title">Finaliser mon inscription</h1>

        <p class="content-paragraph">Hello 👋</p>
        <p class="content-paragraph">Pour finaliser la création de votre compte, cliquez sur le lien ci-dessous :</p>
        <p class="content-paragraph">Si ce n'était pas vous, ignorez simplement cet email.</p>

        <div class="button-container">
            <a href="{{$verificationUrl}}" class="button" target="_blank">Confirmation du compte</a>
        </div>

        <p class="info-text">Si le bouton ne fonctionne pas, vous pouvez copier/coller le lien dans votre navigateur.</p>
        <p class="info-text">{{$verificationUrl}}</p>
