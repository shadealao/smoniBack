                    ...
                    <table id="example" class="table border table-striped table-bordered text-nowrap align-middle">
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-6">
                                            <img src="{{asset($user->photo ?: 'uploads/profil/user-1.jpg')}}" width="45"
                                            class="rounded-circle" />
                                            <h6 class="mb-0 text-center"> {{ $user->firstname.' '.$user->firstname }} </h6>
                                        </div>
                                    </td>
                                    <td> {{ $user->email }} </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="" title="Mes visites" class="btn bg-primary-subtle"><i class="ti ti-home"></i></a>
                                ...
                                @include('admin.file.learners.modal')
                            @endforeach
                        </tbody>
                    </table>
                </div>
